...
#[wasm_bindgen]
pub fn wasm_verify_text(pdf_bytes: &[u8], page_number: u8, sub_string: &str, offset: usize) -> bool {
    verify_text(pdf_bytes.to_vec(), page_number, sub_string, offset).unwrap_or(false)
}
